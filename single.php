...
<html>
<head>
<title>Medi Cure a Medical hospital Category Flat Bootstrap Responsive Website Template | Single :: w3layouts</title>
<!-- for-mobile-apps -->
...
<div class="banner page-head">
	<div class="logo">
		<h1><a href="index.html">LETS HAVE A TEST AND CURB CANCER</a></h1>
	</div>
	<div class="search">		
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Any new skin change?</a>
                </h5>
            </div>
...
<li>
            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Recent change in a wart or mole?</a>
                </h5>
            </div>
...
<li>
            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Indigestion or trouble swallowing?</a>
                </h5>
            </div>
...
<li>
            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Thickening or lump in the breast or other parts of the body?</a>
                </h5>
            </div>
...
<li>
            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Unusual vaginal bleeding or discharge?</a>
                </h5>
            </div>
...
<li>
            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Do you have white patches inside the mouth or white spots on the tongue</a>
                </h5>
            </div>
...
<li>
            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Do you have Sores that do not heal?</a>
                </h5>
            </div>
            <div id="collapseFive" class="panel-collapse collapse in ">
                <div class="panel-body">
                   <input type="radio" name="question-7-answers" id="question-7-answers-A" value="A" required/>
                        <label for="question-7-answers-A"> Yes</label>
        
                        <input type="radio" name="question-7-answers" id="question-7-answers-B" value="B" />
                        <label for="question-7-answers-B"> No</label>
                </div>
            </div>
        </div>
</li>
...
<li>
            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Any Change in bowel habits or bladder function?</a>
                </h5>
            </div>
            <div id="collapseFive" class="panel-collapse collapse in ">
                <div class="panel-body">
                   <input type="radio" name="question-8-answers" id="question-8-answers-A" value="A" required/>
                        ...
                        <label for="question-8-answers-B"> No</label>
                </div>
            </div>
        </div>
</li>
...
<li>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Prolonged, unexplained pain?</a>
                </h5>
            </div>
            <div id="collapseFive" class="panel-collapse collapse in ">
                <div class="panel-body">
...
<li>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Any case of Fatigue?</a>
                </h5>
            </div>
            <div id="collapseFive" class="panel-collapse collapse in ">
                <div class="panel-body">
...
<li>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Any Prolonged fever?</a>
                </h5>
            </div>
            <div id="collapseFive" class="panel-collapse collapse in ">
                <div class="panel-body">
...
<div class="contact-home">
	<div class="map-home">
		...
		<div class="map-pos">
			<div class="login-pad">
				<h2>Subscribe get||get constant reminders</h2>
					<form>
