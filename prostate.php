...
<div id="banner-bottom" class="banner-bottom">
	<div class="container">
		<h3 class="tittle" style="color: #0000ff" >WELCOME TO MEDI PROSTATE CARE</h3>
...
Prostate cancer that is detected early — when it's still confined to the prostate gland — has a better chance of successful treatment.
			...
			<p>	Prostate cancer may cause no signs or symptoms in its early stages.</p>
			<p>
<br>
...
<li>Erectile dysfunction</li>
				...
				<div class="qualify-left-grids">
					<div class="qua-left-gd text-left">
						...
						<p>
<br>
There is debate regarding the risks and benefits of screening for prostate cancer, and medical organizations differ on their recommendations. Discuss prostate cancer screening with your doctor. Together, you can decide what's best for you.</p><br>
