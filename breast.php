...
<div id="banner-bottom" class="banner-bottom">
	<div class="container">
		<h3 class="tittle" style="color: #ff748c" >WELCOME TO MEDI BREAST CARE</h3>
...
<div class="qualified">
	<div class="container">
		<h3 class="tittle">SYMPTOMS</h3>
		<div class="qualified-grids">
			<div class="col-md-8  qualify-left">
				<div class="qualify-left-grids">
					<div class="qua-left-gd text-left">
						<h4>Common Symptoms</h4>
					

		<p>According to the American Cancer Society, any of the following unusual changes in the breast can be a symptom of breast cancer:
			<ul>
				...
				<div class="qualify-left-grids">
					<div class="qua-left-gd text-left">
						<h4>More...</h4>
						<p> Initially, breast cancer may not cause any symptoms. A lump may be too small for you to feel or to cause any unusual changes you can notice on your own. Often, an abnormal area turns up on a screening mammogram (X-ray of the breast), which leads to further testing.</p><br>

		<p>In some cases, however, the first sign of breast cancer is a new lump or mass in the breast that you or your doctor can feel. A lump that is painless, hard, and has uneven edges is more likely to be cancer. But sometimes cancers can be tender, soft, and rounded. So it's important to have anything unusual checked by your doctor.</p><br>


		<p> These changes also can be signs of less serious conditions that are not cancerous, such as an infection or a cyst. It’s important to get any breast changes checked out promptly by a doctor</p><br>

			<p> Learn more about the importance of regular <a href=" ">screening</a> and <a href=" ">testing</a>

			<p> Learn more about breast cancer symptoms and diagnosis. </p><br>

		
					</div>
					<div class="qua-right-gd text-center">
						<img src="IMAGES1/pic1.jpg" alt="" />
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
			<div class="col-md-4 qualify-right grid">
				<figure class="effect-moses">
						<img src="IMAGES1/pic3.jpg" alt="" />
						<figcaption>
