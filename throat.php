...
<div id="banner-bottom" class="banner-bottom">
	<div class="container">
		<h3 class="tittle" style="color: #e200e2" >WELCOME TO MEDI THROAT CARE</h3>
...
<p>
Your voice box sits just below your throat and is also susceptible to throat cancer. The voice box is made of cartilage and contains the vocal cords that vibrate to make sound when you talk.</p><br>
<p>
...
Signs and symptoms of throat cancer may include:
			<ul>
				<li> A cough</li>
				<li> Changes in your voice, such as hoarseness or not speaking clearly</li>
				<li> Difficulty swallowing</li>
				<li> Ear pain</li>
				<li> A lump or sore that doesn't heal</li>
				<li> A sore throat</li>
				<li> Weight loss</li>
			</ul>
				...
				<div class="qualify-left-grids">
					<div class="qua-left-gd text-left">
						...
						<p> Make an appointment with your doctor if you notice any new signs and symptoms that are persistent. Most throat cancer symptoms aren't specific to cancer, so your doctor will likely investigate other more common causes first.</p><br>


						<p> Learn more about the importance of regular <a href=" ">screening</a> and <a href=" ">testing</a></p>

						<p> Learn more about cancer <a href=" ">symptoms</a> and <a href=" ">diagnosis</a> </p><br>
